...
test.describe('Protected API Routes', () => {
    ...
    test.describe('General protected routes', () => {
        ...
        test('Unauthenticated request to get services is rejected', async ({ request }) => {
        ...
        test('Unauthenticated request to get hairdressers is rejected', async ({ request }) => {
        ...
        test('Get upcoming appointments for a hairdresser', async () => {
        ...
        test('Get today appointments for a hairdresser', async () => {
        ...
        test('Unauthenticated user cannot access hairdresser appointments', async ({ request }) => {
            ...
            const response = await request.get('https://frizzy.onrender.com/api/app/getHairdresserAppointments', {
                params: { hairdresserId: validHairdresserId, type: 'upcoming' }
            });
        ...
        test('Client can fetch their appointments with valid clientId', async () => {
            ...
            const clientRes = await clientRequest.get('/api/app/getClients');
            const clientsData = await clientRes.json();
            const validClientId = clientsData.clients[0].id;

            const response = await clientRequest.get('/api/app/getClientAppointments', {
                params: { clientId: validClientId }
            });
        ...
        test('Admin can fetch appointments for a specific client', async () => {
            ...
            const adminRes = await adminRequest.get('/api/app/getClients');
            const adminData = await adminRes.json();
            const validClientId = adminData.clients[0].id;
        ...
        test('Get client appointments with missing clientId', async () => {
    ...
    test.describe('Admin Only Routes', () => {
        ...
        test('Hairdresser registration with short password', async () => {
        ...
        test('Hairdresser registration with short username', async () => {
        ...
        test('Hairdresser registration with missing field', async () => {
    ...
    test.describe('Client Only Routes', () => {
     ...
     test.describe('Shared routes - Client & Admin', () => {
        ...
        test('Delete appointment with missing ID', async () => {
        ...
        test('Delete non-existing appointment', async () => {
